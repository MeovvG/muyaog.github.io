...
if(featureGrid){
  const selectedPhotos=[
    ...
    {file:'selected-01.jpg',shape:'landscape',title:'When the mountain appeared',alt:'Mount Rainier beneath dramatic clouds',description:'Seeing Mount Rainier rise beneath the moving clouds made everything around me feel suddenly quiet. I wanted to hold onto that sense of awe — the mountain distant and immense, yet close enough to make the whole landscape feel alive.',meta:'2026 · Mount Rainier',color:'#46515f'},
