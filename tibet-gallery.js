if(new URLSearchParams(location.search).get('place')==='tibet'){
  ...
  const photos=[
    ...
    ['IMG_8486','A quiet figure beneath golden prayer wheels'],
    ['IMG_8423','The Potala Palace above pale stone'],
    ['IMG_1258','People walking along a sunlit street'],
    ['IMG_8482','An elderly woman walking beside prayer wheels'],
    ...
    ['IMG_8552','Illuminated palace architecture at night'],
    ['IMG_8259','An ornate pavilion beneath trees'],
    ['IMG_8269','Pink flowers in a green garden'],
    ['IMG_8501','Monks gathered inside an ornate temple'],
    ...
    ['IMG_8635','A brown yak with curved horns'],
    ...
    ['IMG_8704','A herder surrounded by black yaks'],
    ['IMG_1259','A person walking beside golden prayer wheels'],
    ['IMG_8563','The Potala Palace and glowing street lamps at night'],
  ...
  photos.forEach(([file,alt])=>{
    ...
    const tall=['IMG_8259','IMG_8423','IMG_8454','IMG_8457.jpg','IMG_8467.jpg','IMG_8469.jpg','IMG_8475','IMG_8482','IMG_8501','IMG_8635','IMG_8704'];
